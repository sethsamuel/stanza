...
/***/ function(module, exports, __webpack_require__) {
	...
	var _syllable = __webpack_require__(181);
	...
	function text() {
		var state = arguments.length <= 0 || arguments[0] === undefined ? { text: '', characterCount: 0, syllables: [] } : arguments[0];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var pluralize = __webpack_require__(182);

	/*
	 * A (small) map of problematic values.
	 */

	var MAP_PROBLEMATIC = __webpack_require__(183);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _character_count = __webpack_require__(187);

	var _character_count2 = _interopRequireDefault(_character_count);

	var _syllables = __webpack_require__(188);
	...
	var Application = (function (_React$Component) {
		...
		_createClass(Application, [{
			...
			value: function render() {
				...
				var twitterLink = "https://twitter.com/share?text=" + encodeURI(this.props.text.text) + " #stanza";

				return _react2.default.createElement(
					"div",
					null,
					_react2.default.createElement(_navigation2.default, null),
					_react2.default.createElement(_input2.default, { onChange: function onChange(text) {
							return dispatch((0, _actions.setText)(text));
						} }),
					_react2.default.createElement(_character_count2.default, { count: text.characterCount }),
					_react2.default.createElement(_syllables2.default, { syllables: text.syllables }),
					_react2.default.createElement(
						"a",
						{ style: linkStyle, href: twitterLink, target: "_blank" },
						"Tweet it!"
					)
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Input = (function (_React$Component) {
		...
		_createClass(Input, [{
			...
			key: "render",
			value: function render() {
				return _react2.default.createElement("textarea", { ref: "textarea", style: style, onChange: this.onChange.bind(this) });
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CharacterCount = (function (_React$Component) {
		_inherits(CharacterCount, _React$Component);

		function CharacterCount() {
			_classCallCheck(this, CharacterCount);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(CharacterCount).apply(this, arguments));
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Syllables = (function (_React$Component) {
		_inherits(Syllables, _React$Component);

		function Syllables() {
			_classCallCheck(this, Syllables);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(Syllables).apply(this, arguments));
		}
		...
		_createClass(Syllables, [{
			...
			value: function render() {
				return _react2.default.createElement(
					"div",
					null,
					this.props.syllables.map(function (n, i) {
						return _react2.default.createElement(
							"div",
							{ key: i, style: style },
							n
	...
	Syllables.propTypes = {
		syllables: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.number).isRequired
	};
